...
// Header Section
define('title','MG Consulting LLC');
...
define('faq','FAQ');
define('partners','Our Partners');
define('contact','Contact');
define('help','Need Help ?');
...
// Index.php page
define('mg','MG Consulting LLC');
define('mg2','Maximum Quality, Great Expertise');
define('contact_slider','Contact Us');
